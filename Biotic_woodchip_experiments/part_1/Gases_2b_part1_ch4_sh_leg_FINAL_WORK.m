...
midPV = PV(88:179);
midC = C(88:179);
midinterpolated_data = interpolated_data(88:179);
p5=jbfill(midPV,midC,midinterpolated_data,color2,[128/255 255/255 0/255],0,transparency)
...
transparency = 1
earlyzerovec=zeros(179,1);
earlyPV = PV(1:179);
earlyinterpolated_data=interpolated_data(1:179);
color3 = [0/255 0/255 128/255];
p6 = jbfill(earlyPV,earlyinterpolated_data,earlyzerovec',color3,[0/255 0/255 128/255],0.5,transparency)
hold on
latePV = PV(179:length(PV));
latezerovec = zeros(length(latePV),1);
lateC = C(179:length(PV));
