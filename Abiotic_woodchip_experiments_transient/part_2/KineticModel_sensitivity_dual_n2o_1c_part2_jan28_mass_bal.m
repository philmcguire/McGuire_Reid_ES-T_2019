...
C_o = 1; %dimensionless
t = 0:50:49950;   %default delta t is 25
...
tracersoldata = csvread('Obj1c_part2_tracer_sol.csv',1,0);
...
headspacedata = csvread('Obj1c_part2_headspace_n2o.csv',1,0);
...
combinedheadspace = csvread('Obj1c_part2_headspace_n2o_combined.csv',1,0);
...
%truncate data to 6.68 pore volumes
shortnormalizedn2o = normalizedn2o(1:872);
shortbubblen2o = bubblen2o(1:872);
shortnormalizedheadspace = normalizedheadspace(1:872);
shortPV = PV(1:872);
...
%legend('Effluent', 'Evolved Headspace', 'Bubble Entrapped', 'Location', 'northwest');
set(gca, 'FontSize', 20);
...
%legend('Effluent', 'Evolved Headspace', 'Predicted Bubble Entrapment/Liberation', 'Unanticipated Bubble Liberation' ); %
set(gca, 'FontSize', 20);
ylim([0 1.2]);
...
%Extend data to 7.68 PVs (Run for 6.68 PVs and add 1 PV for "effluent"
%remaining in reactor at experiment end
integralPV = PV(1:1000);
integralBrC = BrC(1:1000);
integraleff = C(1:1000);
