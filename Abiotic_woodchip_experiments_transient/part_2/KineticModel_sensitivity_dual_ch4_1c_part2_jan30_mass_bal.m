...
headspacedata = csvread('Obj1c_part2_headspace_ch4.csv',1,0);
...
combinedheadspace = csvread('Obj1c_part2_headspace_ch4_combined.csv',1,0);
...
shortnormalizedch4 = normalizedch4(1:872);
shortbubblech4 = bubblech4(1:872);
...
plot(1,1, '--k') 
legend('Effluent','Headspace Evolution Prior to Drainage',['Predicted Bubble Entrapment Prior to Drainage/', newline 'Predicted Bubble Liberation Following Drainage'], 'Unanticipated Bubble Liberation Following Drainage' , 'Reactor Drainage'); %
set(gca, 'FontSize', 20);
%ylim([0 1]);
