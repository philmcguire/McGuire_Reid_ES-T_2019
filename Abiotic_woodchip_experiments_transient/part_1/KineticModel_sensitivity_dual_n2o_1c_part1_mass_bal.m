...
C_o = 1; %dimensionless
t = 0:50:49000;   %default delta t is 25
...
tracersoldata = csvread('Obj1c_part1_tracer_sol.csv',1,0);
...
headspacedata = csvread('Obj1c_part1_headspace_n2o.csv',1,0);
...
combinedheadspace = csvread('Obj1c_part1_headspace_n2o_combined.csv',1,0);
...
%truncate data to 7.41 pore volumes
shortnormalizedn2o = normalizedn2o(1:865);
shortbubblen2o = bubblen2o(1:865);
shortnormalizedheadspace = normalizedheadspace(1:865);
shortPV = PV(1:865);
...
%Extend data to 8.41 PVs (Run for 7.41 PVs and add 1 PV for "effluent"
%remaining in reactor at experiment end
integralPV = PV(1:981);
integralBrC = BrC(1:981);
integraleff = C(1:981);
