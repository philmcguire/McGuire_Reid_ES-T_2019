...
n2oC = G_T.*term + w/R(j) .* integrand_vec;
...
plot(PV, n2oC,'-m','LineWidth',1.5, 'handlevisibility','off')
hold on
...
transparency = 0.5
color = [0.5 0.5 0.5];
ch4fill=jbfill(PV,BrC,n2oC,'m', 'm', 0,transparency)
uistack(ch4fill,'bottom');
legend('Entrapped N_2O','Bromide','N_2O', 'SF_6', 'C_2H_6', 'CH_4', 'He',  'Location', 'southeast'); %
