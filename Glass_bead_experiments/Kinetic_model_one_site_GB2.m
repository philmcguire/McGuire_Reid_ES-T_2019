...
gas_min = xlsread('GB2_gas_data.csv','A2:A21'); %time in min
data_time = gas_min.*60;
ethane = xlsread('GB2_gas_data.csv','B2:B21');
helium = xlsread('GB2_gas_data.csv','C2:C21');
n2o = xlsread('GB2_gas_data.csv','D2:D21');
sf6 = xlsread('GB2_gas_data.csv','E2:E21');
ch4 = xlsread('GB2_gas_data.csv','F2:F21');
br_min = xlsread('GB2_br_data.csv','A2:A28');
br_time = br_min.*60;
Br = xlsread('GB2_br_data.csv','B2:B28');
...
C_o = 1; %dimensionless
t = 0:50:40000;
D = 2.2e-7;    %dispersion coefficients, m2/s, default 5e-7; determined from bromide only.
    %%%%%%1.3e-6 for bromide
v = 7.67e-5;   %velocity, m/s, default 1e-4 m/s
    %%%%%%%4.65e-5 for bromide
...
D = 2.2e-7;%1.6e-7:0.025e-7:2e-7;    %dispersion coefficients, m2/s, default 5e-7; determined from bromide only.
    %%%%%%1.3e-6 for bromide
v = 7.67e-5;%7.4e-5:0.025e-5:7.6e-5;   %velocity, m/s, default 1e-4 m/s
...
R = 1.95;%1.1:0.05:1.7;%1.7;%ethR0;
%heR = 5;        %MUST BE > 1
alpha = 2.45e-4;%10e-5:3e-5:40e-5; %rate constant, try starting in the range 5e-4 to 5e-3
...
R = 1.68;%1.1:0.05:1.7;%1.7;%ethR0;
%heR = 5;        %MUST BE > 1
alpha = 2.05e-4;%10e-5:3e-5:40e-5; %rate constant, try starting in the range 5e-4 to 5e-3
...
R = 1.54;%1.1:0.05:1.7;%1.7;%ethR0;
%heR = 5;        %MUST BE > 1
alpha = 4e-4;%10e-5:3e-5:40e-5; %rate constant, try starting in the range 5e-4 to 5e-3
...
R = 3.12;%1.1:0.05:1.7;%1.7;%ethR0;
%heR = 5;        %MUST BE > 1
alpha = 1.55e-4;%10e-5:3e-5:40e-5; %rate constant, try starting in the range 5e-4 to 5e-3
